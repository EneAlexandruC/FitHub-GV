      ...
      <StatRow>
        <StatCard>
          ...
          <StatContent>
            ...
            <StatLabel>Total antrenamente</StatLabel>
          </StatContent>
        </StatCard>
        <StatCard>
          ...
          <StatContent>
            ...
            <StatLabel>Zile consecutive active</StatLabel>
            <StatSub>Record: {stats.bestStreak ?? 0} zile</StatSub>
          </StatContent>
        </StatCard>
        <StatCard>
          ...
          <StatContent>
            ...
            <StatLabel>Rată de finalizare</StatLabel>
          </StatContent>
        </StatCard>
        <StatCard>
          ...
          <StatContent>
            ...
            <StatLabel>Media/săptămână</StatLabel>
            <StatSub>Luna aceasta: {stats.totalWorkoutsThisMonth ?? 0}</StatSub>
          </StatContent>
        </StatCard>
      </StatRow>
      <Box mt={4}>
        <Paper elevation={2} sx={{ p: 2, textAlign: 'center', borderRadius: 3 }}>
          <Typography variant="h6" color="primary" gutterBottom>
            🏅 Felicitări! Ești la {stats.totalWorkouts ?? 0} antrenamente!
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Ține streak-ul activ și vei debloca noi badge-uri!
          </Typography>
          <Button variant="outlined" sx={{ mt: 2 }} onClick={() => navigate('/workout-builder')}>
            Creează un nou workout
          </Button>
        </Paper>
      </Box>
    </>
